...
MaxLeap Anaylytics SDK helps us track user behavoir and provides data for cloud analytics service, which includes:
...
MaxLeap Analytics helps you learn about your users and their behavoir, thus make more effective marketing strategies with functions as summarized as below:
...
1.    Best practice: MaxLeap provides you with the most competitive analytics parameters and model, and is verified by apps with billions of users. 
2.    Precise Segment: analyze the properties and behavoir of your segments. 
3.    Plenty Reports: MaxLeap provides a whole set of complete and intuitive reports through operator's eyes:
...
**If you want to learn more about MaxLeap Analytics Service SDK, please check [Android Guide - Analytics](ML_DOCS_GUIDE_LINK_PLACEHOLDER_ANDROID#ANALYTICS_EN) or [iOS Guide - Analytics](ML_DOCS_GUIDE_LINK_PLACEHOLDER_IOS#ANALYTICS_EN)。**
...
2.  Events
	...
	As for the achievement of customized events, please check [Android Guide - Analytics](ML_DOCS_GUIDE_LINK_PLACEHOLDER_ANDROID#ANALYTICS_EN) or [iOS Guide - Analytics](ML_DOCS_GUIDE_LINK_PLACEHOLDER_IOS#ANALYTICS_EN) for more details.
...
API Usage shows the usage of MaxLeap cloud service of your app.
...
**If you want to learn more about MaxLeap Analytics Service SDK, please check [iOS Guide － Analytics](ML_DOCS_GUIDE_LINK_PLACEHOLDER_IOS#ANALYTICS_EN) or [Android Guide － Analytics](ML_DOCS_GUIDE_LINK_PLACEHOLDER_ANDROID#ANALYTICS_EN) for more details.**
