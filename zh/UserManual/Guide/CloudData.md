...
* 可结合Cloud Code服务，实现云端数据的Hook （详情请移步至[Java开发指南 － 云数据](LAS_DOCS_GUIDE_LINK_PLACEHOLDER_JAVA)）

**如果您希望进一步了解LAS Cloud Data服务SDK，请参考[iOS开发指南 － 云数据](LAS_DOCS_GUIDE_LINK_PLACEHOLDER_IOS#CLOUD_DATA_ZH)或[Android开发指南 － 云数据](LAS_DOCS_GUIDE_LINK_PLACEHOLDER_ANDROID#CLOUD_DATA_ZH)。**
