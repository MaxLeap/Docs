...
一个人能搞定么，能搞定的那是全才了，不同实现方式需要的资源以及时间也不一样，应用在不同使用规模阶段需要的资源也是不一样

还需要定个目标，OK，我们就以日活跃 5 万的标准为目标，支持 iOS 和 Android 两个平台

好了，我们要做哪些，以及要达到的规模也知道了，接下来要开始进入正题了，来看看我们有哪些实现方案
...
* 人力上，估计得要一个小团队
* 资源上，后端需要 6 台服务器（ 2 台应用服务器 ＋ 2 台缓存、队列服务器 ＋ 2 台数据库）

那么最小资源配置如下：

硬件成本（阿里云）  | 人力成本 | 时间成本
------------- | ------------- | ---------
流量，1500 元/月  | 客户端开发 2 人，40,000 元／月  | 客户端开发，2 个月
...
假如我们没有那么多时间，也找不到牛X的人，我们只是想快速把应用做出来验证想法，还有其他方法么
...
有哪些实时通讯的第三方服务可以选呢，目前市场有好多家，都是大同小异，我们先简单了解一下
...
* 人力上，估计还得要一个小团队
* 资源上，后端需要 4 台服务器（ 2 台应用服务器 ＋ 2 台数据库）

那么最小资源配置如下：

硬件成本（阿里云）  | 人力成本 | 时间成本
------------- | ------------- | ---------
流量，1000 元/月  | 客户端开发 2 人，40,000 元／月  | 客户端开发，1.5 个月
...
既然实时通讯可以使用第三方服务，账号系统和朋友圈模块呢，有没有第三方数据存储服务可以直接使用，然后就关注我们的移动端业务逻辑？
...
* 人力上，移动端工程师
* 资源上，0 后端资源，无需关心高可用、性能、扩展性，我们只要关注我们的创意
