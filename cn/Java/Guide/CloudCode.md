...
[imgWhatsCloudCode](https://gitlab.ilegendsoft.com/web/ils-website/blob/master/app_zh_cn/docssrc/guide/images/imgWHATSCloudCode.png)
...
* 	**如何创建LAS应用**
	...
	> 1. 	在Dashboard中，点击**创建应用**，填写App信息：
			<p class="image-wrapper">
			![imgCreateAppInfo](../../guide/images/imgCreateAppInfo.png)
	...
	>  创建应用后，点击确认，我们便可获取密钥：
	>  <p class="image-wrapper">
	  ![imgCreateAppFinish](../../guide/images/imgCreateAppFinish.png)
	>		
	>  我们也可在App Settings中获取密钥：
	>  <p class="image-wrapper">
			![imgCreateAppGetKey](../../guide/images/imgCreateAppGetKey.png)
	>
